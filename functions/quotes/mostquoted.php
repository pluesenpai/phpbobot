...
function mostquoted($socket, $channel, $sender, $msg, $infos)
{
	...
	if(count($result) > 0) {
		...
		foreach($result as $quote) {
			sendmsg($socket, sprintf($translations->bot_gettext("quotes-mostquoted-message-%s-%s-%s"), "\002{$cont}°\002", "\00311{$quote["the_poster"]}\00301", "\00304{$quote["totale"]}\00301"), $channel, 0, true); //Al \002{$cont}°\002 posto... \00311{$result["the_poster"]}\00301 è stato quotato \00304{$result["totale"]}\00301 volte!
